...
@Configuration
public class PaymentNotificationKafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, PaymentNotification> paymentNotificationProducerFactory() {
        return new DefaultKafkaProducerFactory<>(producerConfig());
    }

    @Bean
    public KafkaTemplate<String, PaymentNotification> paymentNotificationKafkaTemplate(
    ) {
