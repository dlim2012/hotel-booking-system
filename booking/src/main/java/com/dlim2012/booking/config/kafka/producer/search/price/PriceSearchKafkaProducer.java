package com.dlim2012.booking.config.kafka.producer.search.price;
...
@Configuration
public class PriceSearchKafkaProducer {
    ...
    public KafkaTemplate<String, PriceUpdateDetails> roomsSearchPriceUpdateKafkaTemplate(
        ...
        return new KafkaTemplate<>(roomsSearchPriceUpdateProducerFactory());
    }
