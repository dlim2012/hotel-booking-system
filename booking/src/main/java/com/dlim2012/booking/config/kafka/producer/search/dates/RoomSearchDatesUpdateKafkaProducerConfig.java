package com.dlim2012.booking.config.kafka.producer.search.dates;
...
@Configuration
public class RoomSearchDatesUpdateKafkaProducerConfig {
    ...
    public KafkaTemplate<String, DatesUpdateDetails> roomsSearchDatesUpdateKafkaTemplate(
        ...
        return new KafkaTemplate<>(roomsSearchDatesUpdateProducerFactory());
    }
